...
public class AccountServiceTest {
    ...
    public void getAccountDetails_Failure_SpiResponseHasError() {
        ...
        when(accountSpi.requestAccountDetailForAccount(SPI_CONTEXT_DATA, WITH_BALANCE, SPI_ACCOUNT_REFERENCE, SPI_ACCOUNT_CONSENT, spiAspspConsentDataProvider))
    ...
    public void getBalancesReport_Failure_AllowedAccountDataHasError() {
        ...
        when(aisConsentService.getAccountConsentById(CONSENT_ID))
            .thenReturn(Optional.of(accountConsent));
        when(getBalancesReportValidator.validate(new CommonAccountBalanceRequestObject(accountConsent, REQUEST_URI)))
            .thenReturn(ValidationResult.invalid(CONSENT_INVALID_MESSAGE_ERROR));
    ...
    public void getBalancesReport_Failure_SpiResponseHasError() {
        ...
        when(accountSpi.requestBalancesForAccount(SPI_CONTEXT_DATA, SPI_ACCOUNT_REFERENCE, SPI_ACCOUNT_CONSENT, spiAspspConsentDataProvider))
    ...
    public void getBalancesReport_withInvalidConsent_shouldReturnValidationError() {
        ...
        // Then
        verify(getBalancesReportValidator).validate(new CommonAccountBalanceRequestObject(accountConsent, REQUEST_URI));
        assertThat(actualResponse).isNotNull();
        assertThat(actualResponse.hasError()).isTrue();
        assertThat(actualResponse.getError()).isEqualTo(VALIDATION_ERROR);
    }
    ...
    public void getTransactionsReportByPeriod_Failure_AllowedAccountDataHasError() {
        ...
        when(getTransactionsReportValidator.validate(new CommonAccountRequestObject(accountConsent, ACCOUNT_ID, WITH_BALANCE, REQUEST_URI)))
            .thenReturn(ValidationResult.invalid(CONSENT_INVALID_MESSAGE_ERROR));

        ResponseObject<Xs2aTransactionsReport> actualResponse = accountService.getTransactionsReportByPeriod(CONSENT_ID, ACCOUNT_ID, MediaType.APPLICATION_JSON_VALUE, WITH_BALANCE, DATE_FROM, DATE_TO, BOOKING_STATUS, REQUEST_URI);
    ...
    public void getTransactionsReportByPeriod_Failure_SpiResponseHasError() {
        ...
        when(accountSpi.requestTransactionsForAccount(SPI_CONTEXT_DATA, MediaType.APPLICATION_JSON_VALUE, WITH_BALANCE, DATE_FROM, DATE_TO, BOOKING_STATUS, SPI_ACCOUNT_REFERENCE, SPI_ACCOUNT_CONSENT, spiAspspConsentDataProvider))
    ...
    public void getTransactionsReportByPeriod_Success_ShouldRecordEvent() {
        ...
        // When
        accountService.getTransactionsReportByPeriod(CONSENT_ID, ACCOUNT_ID, MediaType.APPLICATION_JSON_VALUE, WITH_BALANCE, DATE_FROM, DATE_TO, BOOKING_STATUS, REQUEST_URI);
    ...
    public void getTransactionsReportByPeriod_withInvalidConsent_shouldReturnValidationError() {
        ...
        // Then
        verify(getTransactionsReportValidator).validate(new CommonAccountRequestObject(accountConsent, ACCOUNT_ID, WITH_BALANCE, REQUEST_URI));
        assertThat(actualResponse).isNotNull();
        assertThat(actualResponse.hasError()).isTrue();
        assertThat(actualResponse.getError()).isEqualTo(VALIDATION_ERROR);
    }
    ...
    public void getTransactionDetails_Failure_AllowedAccountDataHasError() {
        ...
        when(getTransactionDetailsValidator.validate(new CommonAccountTransactionsRequestObject(accountConsent, REQUEST_URI)))
            .thenReturn(ValidationResult.invalid(CONSENT_INVALID_MESSAGE_ERROR));
    ...
    public void getTransactionDetails_Failure_SpiResponseHasError() {
        ...
        when(accountSpi.requestTransactionForAccountByTransactionId(SPI_CONTEXT_DATA, TRANSACTION_ID, SPI_ACCOUNT_REFERENCE, SPI_ACCOUNT_CONSENT, spiAspspConsentDataProvider))
    ...
    public void getTransactionDetails_withInvalidConsent_shouldReturnValidationError() {
        ...
        // Then
        verify(getTransactionDetailsValidator).validate(new CommonAccountTransactionsRequestObject(accountConsent, REQUEST_URI));
        assertThat(actualResponse).isNotNull();
        assertThat(actualResponse.hasError()).isTrue();
        assertThat(actualResponse.getError()).isEqualTo(VALIDATION_ERROR);
    }
